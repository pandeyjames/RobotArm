...
const QMetaObject Scenario::staticMetaObject = {
    { &GMlibWrapper::staticMetaObject, qt_meta_stringdata_Scenario.data,
      qt_meta_data_Scenario,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Scenario::qt_metacast(const char *_clname)
{
    ...
    return GMlibWrapper::qt_metacast(_clname);
}

int Scenario::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = GMlibWrapper::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    return _id;
}
